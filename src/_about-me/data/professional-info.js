    ...
    files: [
      ...
      },
      {
        ...
        fileContent: [
          ...
          "",
          "Natural Language Processing: Text Preprocessing, Word Embeddings, Transformers (BERT, GPT), Sentiment Analysis, Named Entity Recognition, LLMs",
          "",
          "Graph Neural Networks (GNNs): Graph Convolutions, Explainability (GraphLIME)",
          "",
          "Reinforcement & Self-Supervised Learning",
          "",
          "Optimal Transport Methods & Fairness-Aware ML",
          "",
          "Big Data & Data Engineering: Hadoop, Spark, Data Warehousing, ETL Processes, large-scale dataset management",
          "",
          "Languages: Python, SQL, Bash, C++",
          "",
          "Data Science, Analytics & Visualization: Data Wrangling & Cleaning, Feature Engineering, Data Visualization (Matplotlib, Seaborn)",
          "",
          "Frameworks & Libraries: PyTorch, TensorFlow, Keras, Hugging Face Transformers, PyTorch Geometric (PyG)",
          "",
          "Model Deployment: Streamlit",
          "",
          "Cloud & Platforms: Google Colab, Kaggle",
          "",
          "Development Tools: Git/GitHub, Docker, Jupyter Notebook, VS Code, Linux",
          "",
          "Version Control: Git/GitHub",
          "",
          "Mathematical & Theoretical Foundations: Linear Algebra for ML, Probability & Statistics, Optimization Techniques (Gradient Descent, Convex Optimization)",
          "",
