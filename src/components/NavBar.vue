...
function elementHovered(val) {
  activeBar.value = {
    width: val.target.offsetWidth,
    posY: val.target.offsetLeft
  }
}

function hoverLeave(e) {
  const activeElement = document.getElementById(navStore.activeElement);
  activeBar.value = {
    width: activeElement.offsetWidth,
    posY: activeElement.offsetLeft,
  };
}
